...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        'attribute_is_variation_ids' => 'ویژگی های متغیر',
        'brand_id'              => 'برند',
        'tag_ids'               => 'تگ ها',
        'primary_img'           => 'تصویر اصلی',
        'other_imgs'            => 'تصاویر دیگر',
        'category_id'           => 'دسته بندی',
        'attribute_ids.*'       => 'ویژگی ها',
        'variation_values'      => 'متغیر',
        'variation_values.price.0'=> 'ویژگی اول: قیمت',
        'variation_values.value.0'=> 'ویژگی اول: اسم',
        'variation_values.quantity.0'=> 'ویژگی اول: تعداد',
        'variation_values.price.1'=> 'ویژگی دوم: قیمت',
        'variation_values.value.1'=> 'ویژگی دوم: اسم',
        'variation_values.quantity.1'=> 'ویژگی دوم: تعداد',
        'variation_values.price.2'=> 'ویژگی سوم: قیمت',
        'variation_values.value.2'=> 'ویژگی سوم: اسم',
        'variation_values.quantity.2'=> 'ویژگی سوم: تعداد',
        'variation_values.price.3'=> 'ویژگی چهارم: قیمت',
        'variation_values.value.3'=> 'ویژگی چهارم: اسم',
        'variation_values.quantity.3'=> 'ویژگی چهارم: تعداد',
        'variation_values.price.4'=> 'ویژگی پنجم: قیمت',
        'variation_values.value.4'=> 'ویژگی پنجم: اسم',
        'variation_values.quantity.4'=> 'ویژگی پنجم: تعداد',
        'variation_values.price.5'=> 'ویژگی ششم: قیمت',
        'variation_values.value.5'=> 'ویژگی ششم: اسم',
        'variation_values.quantity.5'=> 'ویژگی ششم: تعداد',
        'variation_values.price.6'=> 'ویژگی هفتم: قیمت',
        'variation_values.value.6'=> 'ویژگی هفتم: اسم',
        'variation_values.quantity.6'=> 'ویژگی هفتم: تعداد',
        'variation_values.price.7'=> 'ویژگی هشتم: قیمت',
        'variation_values.value.7'=> 'ویژگی هشتم: اسم',
        'variation_values.quantity.7'=> 'ویژگی هشتم: تعداد',
        'variation_values.price.8'=> 'ویژگی نهم: قیمت',
        'variation_values.value.8'=> 'ویژگی نهم: اسم',
        'variation_values.quantity.8'=> 'ویژگی نهم: تعداد',
        'variation_values.price.9'=> 'ویژگی دهم: قیمت',
        'variation_values.value.9'=> 'ویژگی دهم: اسم',
        'variation_values.quantity.9'=> 'ویژگی دهم: تعداد',
