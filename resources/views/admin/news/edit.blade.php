...
@section('content')
    <div class="mx-4">
        ...
        <form action="{{ route('admin.news.update' , ['news' => $news->id]) }}" method="POST" class="row" enctype="multipart/form-data">
            @csrf
            @method('put')
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-lg-4">
                                ...
                                <input type="text" name="slug" id="slug" class="form-control" placeholder="{{$news->slug}}">
                            </div>
                            ...
                            <div class="form-group col-12 col-lg-6">
                                ...
                                <select class="form-control" id="is_active" name="is_active">
                                    <option value="1" {{ $news->getRawOriginal('is_active') ? 'selected' : '' }}>فعال</option>
                                    <option value="0" {{ $news->getRawOriginal('is_active') ? '' : 'selected' }}>غیرفعال</option>
                                </select>
                            </div>
                            <div class="form-group col-12 col-lg-12">
                                <label for="summernote">متن*</label>
                                <textarea id="summernote" type="text" name="text" class="form-control">{{ $news->text }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <img class="card-img" src="{{ url(env('NEWS_IMAGE_UPLOAD_PATH')) . '/' . $news->primary_image }}" alt="{{ $news->title }}-image">
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <a href="{{ route('admin.news.index') }}" class="btn btn-danger w-100" type="cancel" name="cancel">بازگشت</a>
                            </div>
                        </div>
                    </div>
                </div>
