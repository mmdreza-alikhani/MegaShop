                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                ...
                                <input type="text" value="{{ verta($permission->created_at) }}" class="form-control" disabled>
                            </div>
                            <div class="form-group col-12 col-lg-6">
                                <label>تاریخ آخرین تغییرات</label>
                                <input type="text" value="{{ verta($permission->updated_at) }}" class="form-control" disabled>
                            </div>
                        </div>
