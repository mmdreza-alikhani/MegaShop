...
@section('content')
    <div class="mx-4">
        ...
        <form action="{{ route('admin.products.update' , ['product' => $product->slug]) }}" method="POST" class="row"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                ...
                                <input type="text" name="delivery_amount" id="delivery_amount"
                                       value="{{ $product->delivery_amount }}" class="form-control">
                            </div>
                            <div class="form-group col-12 col-lg-6">
                                ...
                                <input type="text" name="delivery_amount_per_product" id="delivery_amount_per_product"
                                       value="{{ $product->delivery_amount_per_product }}" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-12">
                                                ...
                                                <input id="quantity" type="text"
                                                       ...
                                                       value="{{ $variation->quantity }}" class="form-control">
                                            </div>
                                            <div class="form-group col-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                @foreach($productAttributes as $productAttribute)
                                    <div class="form-group col-12 col-lg-6">
                                        <label for="{{ $productAttribute->value }}">{{ $productAttribute->attribute->name }}
                                            *</label>
                                        <input id="{{ $productAttribute->value }}" type="text"
                                               name="attribute_values[{{ $productAttribute->id }}]"
                                               value="{{ $productAttribute->value }}" class="form-control">
                                    </div>
                                @endforeach
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <a href="{{ route('admin.products.index') }}" class="btn btn-danger w-100"
