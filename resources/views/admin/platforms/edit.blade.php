...
@section('content')
    <div class="mx-4">
        ...
        <form action="{{ route('admin.platforms.update' , ['platform' => $platform->slug]) }}" method="POST" class="row" enctype="multipart/form-data">
            @csrf
            @method('put')
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-lg-6">
                                ...
                                <select class="form-control" id="is_active" name="is_active">
                                    <option value="1" {{ $platform->getRawOriginal('is_active') ? 'selected' : '' }}>فعال</option>
                                    <option value="0" {{ $platform->getRawOriginal('is_active') ? '' : 'selected' }}>غیرفعال</option>
                                </select>
                            </div>
                        </div>
                    </div>
