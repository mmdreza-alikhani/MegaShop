...
<div class="container my-3">
    <ul class="nk-breadcrumbs text-right" style="direction: rtl">
        ...
        <li><span>نهایی کردن خرید</span></li>
    </ul>
</div>
<div class="nk-gap-1"></div>
<!-- END: Breadcrumbs -->
    ...
    <div class="nk-store nk-store-checkout row">
        ...
        @csrf
            <div class="col-lg-7 col-12 text-right" style="direction: rtl">
                ...
                <h3 class="nk-decorated-h-2"><span><span class="text-main-1">سفارش</span> شما:</span></h3>
                <div class="nk-gap"></div>
                <div class="table-responsive">
                    <table class="nk-table nk-table-sm">
                        <thead class="thead-default">
                        <tr>
                            <th class="nk-product-cart-title">محصولات</th>
                            <th class="nk-product-cart-total">قیمت</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        @foreach(cartItems() as $product)
                            <tr>
                                ...
                                <td class="nk-product-cart-total">
                                    {{ number_format($product->variation->price * $product->quantity) }}
        ...
        {{--                    </tr>--}}
                        <tr class="nk-store-cart-totals-total">
                            ...
                            <td>
                                {{ number_format(cartPayingAmount()) }} <i id="tooman_icon" class="icony icony-toman"></i>
                            </td>
                        </tr>
                        <tr class="nk-store-cart-totals-total">
                            <td>
                            ...
                            <td>
                                <div class="badge badge-info text-right" style="direction: rtl">
                                    پی
                                </div>
                            </td>
                        </tr>
                ...
                <button class="nk-btn nk-btn-rounded nk-btn-color-main-1" type="submit">ثبت سفارش</button>
            </div>

            <div class="col-lg-5 col-12">
                <h3 class="nk-decorated-h-2"><span><span class="text-main-1">مشخصات</span> سفارش</span></h3>
                ...
                <div class="row vertical-gap text-right" style="direction: rtl">
                    ...
                    @else
                        <div class="col-lg-8">
                            ...
                            <select name="address_id" class="form-control required" id="address_id">
