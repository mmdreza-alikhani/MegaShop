    ...
    <div class="info-box p-4 m-2 h-100 w-100 row rounded">
        ...
        @csrf
            <div class="col-12 col-lg-12 text-right" style="direction: rtl">
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control" placeholder="رمز عبور جدید خود را وارد کنید.." id="newPassword" name="newPassword" value="{{ old('newPassword') }}">
                </div>

                <label for="confirmNewPassword">تکرار کلمه عبور جدید:</label>
                <div class="input-group mb-3">
                    <input type="password" class="form-control" placeholder="رمز عبور جدید خود را وارد کنید.." id="confirmNewPassword" name="confirmNewPassword" value="{{ old('confirmNewPassword') }}">
                </div>
