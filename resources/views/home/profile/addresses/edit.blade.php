...
@section('section')
    <div class="info-box p-5 m-2 h-100 w-100 row rounded" style="background-color: rgba(35,41,48,.6);direction: rtl">
        <aside class="nk-sidebar nk-sidebar-right nk-sidebar-sticky">
            <div class="nk-widget nk-widget-highlighted" style="direction: rtl">
                <ul class="nk-breadcrumbs text-right px-3" style="direction: rtl">
                    <li><span style="font-size: 24px">ویرایش آدرس: {{ $address->title }}</span></li>
                </ul>
            </div>
        </aside>
        ...
        <div class="mx-4">
            ...
            <form action="{{ route('home.profile.addresses.update', ['address' => $address->id]) }}" method="POST" class="row text-right" style="direction: rtl">
                @method('PUT')
                @csrf
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="عنوان" id="title" value="{{ $address->title }}" name="title">
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="کد پستی" id="postalCode" value="{{ $address->postal_code }}" name="postalCode">
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-12">
                    ...
                    <a class="btn btn-danger" href="{{ route('home.profile.addresses.index') }}">بازگشت</a>
                </div>
            </form>
        </div>
    </div>
