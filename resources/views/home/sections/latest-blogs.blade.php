        ...
        @foreach($articles as $article)
            <div class="col-md-6">
                ...
                <div class="nk-blog-post">
                    ...
                    <div class="nk-gap"></div>
                    <h2 class="nk-post-title h4 text-right" style="direction: rtl"><a href="{{ route('home.articles.show', ['article' => $article->slug]) }}">{{ $article->title }}</a></h2>
                    ...
                    <div class="nk-gap"></div>
                    <a href="{{ route('home.articles.show', ['article' => $article->slug]) }}" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">ادامه مطلب</a>
                </div>
                <!-- END: Post -->
            </div>
        @endforeach
