            ...
            <div class="nk-store-product">
                ...
                <div class="nk-tabs">
                    <ul class="nav nav-tabs" role="tablist" style="direction: rtl">
                        <li class="nav-item">
                            <a class="nav-link {{ count($errors->storeComment) > 0 ? '' : 'active'}} " id="description" href="#tab-description" role="tab" data-toggle="tab">توضیحات</a>
                        </li>
                        <li class="nav-item mx-1">
                            <a class="nav-link {{ count($errors->storeComment) > 0 ? 'active' : ''}} " id="reviews" href="#tab-reviews" role="tab" data-toggle="tab">نظرات ({{ $product->comments()->count() }})</a>
                        </li>
                    </ul>
