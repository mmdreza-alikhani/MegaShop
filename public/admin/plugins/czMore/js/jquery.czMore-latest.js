...
(function ($, undefined) {
    ...
    $.fn.czMore = function (options) {
        ...
        return this.each(function () {
            ...
            var count = '<input id="' + this.id + options.countFieldPrefix + '" name="' + this.id + options.countFieldPrefix + '" type="hidden" value="0" size="5" class="form-control" />';
            ...
            if(!options.styleOverride) {
              btnPlus.css({
                  'float': 'right',
                  'border': '0px',
                  // 'background-image': 'url("/admin/plugins/czMore/img/add.png")',
              ...
              btnPlus.append($('<i/>', {
                  class: 'fa fa-lg fa-plus text-success'
              }))
            }
            ...
            function loadMinus(recordset) {
                ...
                if(!options.styleOverride) {
                  btnMinus.css({
                      'float': 'right',
                      'border': '0px',
                      // 'background-image': 'url("/admin/plugins/czMore/img/remove.png")',
                      'background-position': 'center center',
                      'background-repeat': 'no-repeat',
                      'height': '25px',
                      'width': '25px',
                ...
                btnMinus.append($('<i/>', {
                    class: 'fa fa-lg fa-remove text-danger'
                }))
              }
            }
